...
### This is the latest update of the project with Agentic AI: (https://github.com/OpelSpeedster/EcoAgent-AAI-)  and HF Space: (https://huggingface.co/spaces/OpelSpeedster/EcoAgent) 
